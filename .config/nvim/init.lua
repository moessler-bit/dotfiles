...
vim.api.nvim_create_autocmd("BufAdd", {
	callback = function(ev)
		print(string.format("buffer added: [%s] > %s", ev.buf, ev.file))
	end,
})
...
require("lazy").setup({
	...
	"tpope/vim-fugitive", -- Best Git client
		...
		config = function()
			...
			local servers = {
				...
				require("lspconfig").clangd.setup({
					...
					-- Include any additional settings you require
				}),
			}
				...
				handlers = {
					function(server_name)
						if server_name == "clangd" then
							-- Skip setting up clangd; we'll handle it manually
							return
						end
